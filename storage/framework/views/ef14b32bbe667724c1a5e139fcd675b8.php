        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-t"  onclick="document.getElementById('DetailModal-<?php echo e($category->category_id); ?>').showModal()">
                        <td class="px-4 py-2"><?php echo e($loop->iteration); ?></td>
                        <td class="px-4 py-2"><?php echo e($category->category_name); ?></td>
                        <td class="px-4 py-2"><?php echo e($category->category_description); ?></td>
                    </tr>
<dialog id="DetailModal-<?php echo e($category->category_id); ?>" class="modal">
    <div class="modal-box bg-white rounded-lg shadow-lg w-full max-w-xl fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style="padding: 20px">
        ...
        <form action="<?php echo e(route('admin.category.update', ['category_id' => $category->category_id])); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                />
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['category_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                ><?php echo e($category->category_description); ?></textarea>
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['category_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<form action="<?php echo e(route('admin.category.delete', ['category_id' => $category->category_id])); ?>" method="POST" class="mt-2 flex justify-end">
    <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\laragon\www\projekHani\resources\views/livewire/admin/author/category.blade.php ENDPATH**/ ?>