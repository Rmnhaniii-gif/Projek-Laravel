    ...
    <?php if(auth()->guard()->check()): ?>
        <div class="relative hidden lg:flex lg:items-center lg:gap-4">
            <p class="font-medium text-sm text-gray-800">
                <?php echo e(Auth::user()->firstname ?? 'Admin'); ?> <?php echo e(Auth::user()->lastname ?? ''); ?>
            ...
            <button id="profileDropdownButton" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 focus:outline-none">
                <span class="font-semibold text-gray-800">
                    <?php echo e(strtoupper(substr(Auth::user()->firstname ?? 'A', 0, 1))); ?>
...
<?php /**PATH D:\laragon\www\projekHani\resources\views/components/admin/navbar.blade.php ENDPATH**/ ?>