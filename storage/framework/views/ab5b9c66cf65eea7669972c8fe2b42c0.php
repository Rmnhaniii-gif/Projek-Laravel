...
>
                    ...
                    <table class="min-w-full text-sm text-left">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $shelves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shelf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-t" onclick="document.getElementById('shelfDetailModal-<?php echo e($shelf->shelf_id); ?>').showModal()">
                                    <td class="px-4 py-2"><?php echo e($loop->iteration); ?></td>
                                    <td class="px-4 py-2"><?php echo e($shelf->shelf_name); ?></td>
                                    <td class="px-4 py-2"><?php echo e($shelf->shelf_position); ?></td>
                                </tr>

                                <!-- Modal for update/delete -->
    <dialog id="shelfDetailModal-<?php echo e($shelf->shelf_id); ?>" class="modal">
    <div class="modal-box bg-white rounded-lg shadow-lg w-full max-w-xl fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style="padding: 20px">
        ...
        <form action="<?php echo e(route('admin.shelf.update', ['shelf_id' => $shelf->shelf_id])); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                />
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['shelf_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                ><?php echo e($shelf->shelf_position); ?></textarea>
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['shelf_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<form action="<?php echo e(route('admin.shelf.delete', ['shelf_id' => $shelf->shelf_id])); ?>" method="POST" class="mt-2 flex justify-end">
    <?php echo csrf_field(); ?>
    ...
    <button type="submit"
        class="px-3 py-2 bg-red-600 rounded text-sm text-white font-medium transition-all duration-300">Delete</button>
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <hr class="mb-4">
                <form action="<?php echo e(route('admin.shelf.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\laragon\www\projekHani\resources\views/livewire/admin/author/shelf.blade.php ENDPATH**/ ?>