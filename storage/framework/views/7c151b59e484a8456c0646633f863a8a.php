          ...
          <?php $__empty_1 = true; $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="hover:bg-gray-50 transition">
              ...
              <td class="px-6 py-4 font-medium text-gray-800">
                <?php echo e($borrowing->user->firstname); ?> <?php echo e($borrowing->user->lastname); ?>
              ...
              <td class="px-6 py-4 text-gray-700">
                  ...
                  <?php $__currentLoopData = $borrowing->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e($detail->book->book_name); ?>

                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
              </td>
              <td class="px-6 py-4 text-gray-600">
                <?php echo e($borrowing->borrowing_notes ?? '-'); ?>

              </td>
              <td class="px-6 py-4 text-gray-700">
                Rp<?php echo e(number_format($borrowing->borrowing_fine ?? 0, 0, ',', '.')); ?>

              </td>
              <td class="px-6 py-4">
                <?php if($borrowing->borrowing_isreturned): ?>
              ...
              <td class="px-6 py-4">
                <?php if(!$borrowing->borrowing_isreturned): ?>
                  <form method="POST"
                        action="<?php echo e(route('user.borrowings.return', $borrowing->borrowing_id)); ?>"
...
</html><?php /**PATH D:\laragon\www\projekHani\resources\views/pages/student/borrowing.blade.php ENDPATH**/ ?>