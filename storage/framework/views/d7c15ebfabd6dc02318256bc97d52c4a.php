...
[$__name, $__params] = $__split('admin.author.category', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-532801558-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\projekHani\resources\views/pages/admin/category.blade.php ENDPATH**/ ?>