    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-md transition duration-300">
          <div class="p-4">
            <h3 class="text-lg font-semibold text-gray-800"><?php echo e($book->book_name); ?></h3>
            <p class="text-sm text-gray-600 mt-1">By <?php echo e($book->author->author_name ?? '-'); ?></p>
            <p class="text-sm text-gray-500">Publisher: <?php echo e($book->publisher->publisher_name ?? '-'); ?></p>
            <p class="text-sm text-gray-500">Category: <?php echo e($book->category->category_name ?? '-'); ?></p>
            <p class="text-sm text-gray-500">Shelf: <?php echo e($book->shelf->shelf_name ?? '-'); ?></p>
            <div class="mt-3 flex justify-between items-center">
              <span class="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">
                Stock: <?php echo e($book->book_stock); ?>

              </span>
              <span class="text-xs font-mono text-gray-500">
                ISBN: <?php echo e($book->book_isbn); ?>
            ...
            <?php if($loggedIn): ?>
              <form method="POST" action="<?php echo e(route('borrow.book', $book->book_id)); ?>"
...
</html><?php /**PATH D:\laragon\www\projekHani\resources\views/pages/student/index.blade.php ENDPATH**/ ?>